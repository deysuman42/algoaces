...
IF sufficient information is not there in the context, politely refuse to answer the question.
...
First Identify duplicate rows in the data and remove them.

Next, Act as a 'Data Analyst' expert and and answer the question enclosed within **Question** accurately from the context enclosed within **Context**. \
    Understand the question and list down your thought process step by step to arrive at the answer. \
    Think as a the Python expert and perform the calculations. The calculation should be accurate. \
    Remember you are an expert in calculating and generating reports. \
    DO NOT PRINT YOUR THOUGHTS IN THE OUTPUT
...
Next, act as a 'Reviewer' and validate the report generated by the 'Data Analyst'. Provide feedback on the report and validate the quantitaive numbers. \
    Highlight any errors or inconsistencies in the report. DO NOT PRIINT REVIEWER'S THOUGHTS IN THE OUTPUT.
...
Next, act as a 'Refiner' and refine the report generated by the 'Data Analyst' and 'Reviewer'. Provide a more polished and professional version of the report.\
    DO NOT PRINT REFINER'S THOUGHTS IN THE OUTPUT.

Finally, act as a 'Finalizer' and finalize the report.\
    Provide the final output of the report in a well-structured format. DO NOT INCLUDE ANY OTHER TEXT OR EXPLANATION.
